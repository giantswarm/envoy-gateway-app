...
| kubectlApplyJob.files[0] | string | `"files/gateway.envoyproxy.io-backends.yaml"` |  |
| kubectlApplyJob.files[1] | string | `"files/gateway.envoyproxy.io-backendtrafficpolicies.yaml"` |  |
| kubectlApplyJob.files[2] | string | `"files/gateway.envoyproxy.io-clienttrafficpolicies.yaml"` |  |
| kubectlApplyJob.files[3] | string | `"files/gateway.envoyproxy.io-envoyextensionpolicies.yaml"` |  |
| kubectlApplyJob.files[4] | string | `"files/gateway.envoyproxy.io-envoypatchpolicies.yaml"` |  |
